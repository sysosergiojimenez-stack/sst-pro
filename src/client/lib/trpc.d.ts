export declare const trpc: import("@trpc/react-query").CreateTRPCReactBase<import("@trpc/server").TRPCBuiltRouter<{
    ...
    empleados: import("@trpc/server").TRPCBuiltRouter<{
        ...
        list: import("@trpc/server").TRPCQueryProcedure<{
            input: void;
            output: import("../../server/lib/googleSheets").Empleado[];
            meta: object;
        }>;
        ...
        extraerConGemini: import("@trpc/server").TRPCMutationProcedure<{
            input: void;
            output: import("../../server/lib/googleSheets").DatosExtraidosPDF;
            meta: object;
        }>;
    }>>;
    incidentes: import("@trpc/server").TRPCBuiltRouter<{
        ...
        list: import("@trpc/server").TRPCQueryProcedure<{
            input: void;
            output: import("../../server/lib/googleSheets").Incidente[];
            meta: object;
        }>;
        create: import("@trpc/server").TRPCMutationProcedure<{
            input: {
...
}>>, unknown> & import("node_modules/@trpc/react-query/dist/getQueryKey.d-CruH3ncI.d.mts").DecorateRouterRecord<{
    ctx: {
        user: null;
    };
    meta: object;
